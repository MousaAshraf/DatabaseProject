...
-- Create sample users (including admin users)
...
-- Sample payments (without payment_method field)
...
-- Updated: Daily revenue summary (without payment_method grouping)
